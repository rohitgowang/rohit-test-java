...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.cors().and().csrf().disable().authorizeRequests().antMatchers(HttpMethod.POST, "/signUp").permitAll()
				...
				.addFilter(new com.hubino.upwork.security.AuthenticationFilter(authenticationManager()))
				.addFilter(new com.hubino.upwork.security.AuthorizationFilter(authenticationManager()))
